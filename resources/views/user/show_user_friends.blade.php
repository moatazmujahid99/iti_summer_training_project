                ...
                @foreach ($user->getAcceptedFriendships() as $friend)
                    ...
                    @if ($friend->recipient_id === $user->id)
                        ...
                        <li class="list-group-item mb-1">
                            <a href="/users/{{$friend->sender->id}}/profile" title="Show Details" style="font-weight: bold;text-decoration: none;color:black">
                    ...
                    @elseif($friend->sender_id === $user->id)
                        ...
                        <li class="list-group-item mb-1">
                            <a href="/users/{{$friend->recipient->id}}/profile" title="Show Details" style="font-weight: bold;text-decoration: none;color:black">
                                <img src="{{$image_path}}" alt="" width="74" height="62">&nbsp;

                                        ...
                                        <div class="profile-header-content">
                                            ...
                                            <div class="profile-header-info">
                                                ...
                                                @if (Auth::user()->hasSentFriendRequestTo($user))
                                                    ...
                                                    <span class="" style=" font-weight:bold; color:white">Your
                                                        Request Is Sent Successfully</span>
                                                ...
                                                @elseif(Auth::user()->isFriendWith($user))
                                                    ...
                                                    <spna class="" style=" font-weight:bold; color:white">You and
                                                        {{ $user->first_name }} are friends</spna>

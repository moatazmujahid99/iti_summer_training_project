                ...
                @foreach ($friends as $friend)
                    ...
                    @if ($friend->recipient_id === Auth::user()->id)
                        ...
                        <li class="list-group-item mb-1">
                            ...
                            <a href="/unfriend/{{$friend->sender->id}}" class="btn btn-danger float-right mt-2 mr-3">Unfriend</a>
                        </li>
                    ...
                    @elseif($friend->sender_id === Auth::user()->id)
                        ...
                        <li class="list-group-item mb-1">
                            ...
                            <a href="/unfriend/{{$friend->recipient->id}}" class="btn btn-danger float-right mt-2 mr-3">Unfriend</a>
                        </li>

                        ...
                        <div class="inner-all">
                            <ul class="list-unstyled">
                                ...
                                <li class="text-center">
                                    ...
                                    <img width="185" height="195" class="center" style="border-radius: 50%" src={{ asset('images/users/' . Auth::user()->user_img) }}>
                                </li>
                                <!--************** END of My Profile pic ****************-->




                                <!--************** Start of My Name and bio ****************-->
                                ...
                                <!--************** END of My Name and bio ****************-->



                                <!--************** Start of My Account ****************-->
                                <li>
                                    <a href="{{ url("/users/".Auth::id()."/profile") }}" class="btn btn-success text-center btn-block"
                                        style="background-color: rgb(66 103 178)">My Account</a>
                                </li>
                                <!--************** End of My Account ****************-->
                        ...
                        <div class="inner-cover">
                            ...
                            <div class="btn-group cover-menu-mobile hidden-lg hidden-md">
                                ...
                                <ul class="dropdown-menu pull-right no-border" role="menu">
                                    ...
                                    <li>
                                        <a href="/users/{{Auth::id()}}/about">
                                            <i class="fa fa-fw fa-user"></i>
                                            <span>About</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="users/{{Auth::id()}}/friends">
